...
// for linked list
node *first;    //pointer for first space node
node *last;     //pointer for last node
// for linked stack
node *top;    //pointer for top stack node
// for linked queue
node *rear = NULL;  //pointer for last queue node
node *front = NULL;   //pointer for front queue node
...
void reverseList() { // linked list reversed
	node* prev = first;          //pointer for previous node
	node* current = first->next;  //pointer for current node
